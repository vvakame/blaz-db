 ...
 * @param <P>
 */
public class PropertyConverterAttributeMeta<T, R> extends CoreAttributeMeta<T>
		implements PropertyAttributeMetaInterface<T> {
	...
	/**
	 * the constructor. for single value property.
	 * 
	 * @param name
	 * @param fromClazz
	 * @param toClazz
	...
	public PropertyConverterAttributeMeta(String name, Class<?> fromClazz,
	...
	@Override
	public Class<? super R> getPropertyClass() {
		return toClazz;
	}
